...
load('./data/trajectory.proposed.a.mc.rdata')
...
load('./data/rank.proposed.a.mc.rdata')
rank.proposed.a.mc = rank.proposed.a.mc$order[1:20]

trajs.proposed.a.mc = trajs.proposed.a.mc[ rank.proposed.a.mc ]
rank.proposed.a.mc = 1:20
...
f.t0.mc = mclapply(trajs.proposed.a.mc, as.ordinal, data=d.t0.mc, exclusion=TRUE, mc.cores=mc.cores)
f.t1.mc = mclapply(trajs.proposed.a.mc, as.ordinal, data=d.t1.mc, exclusion=TRUE, mc.cores=mc.cores)
f.t0.mc = cbind.data.frame(f.t0.mc)
f.t1.mc = cbind.data.frame(f.t1.mc)
colnames(f.t0.mc) = paste('t', 1:length(trajs.proposed.a.mc), sep='')
colnames(f.t1.mc) = paste('t', 1:length(trajs.proposed.a.mc), sep='')
...
# Convert a data to a set of prefixes.
f.t0.fv = mclapply(trajs.proposed.a.mc, as.ordinal, data=d.t0.fv, exclusion=TRUE, mc.cores=mc.cores)
f.t1.fv = mclapply(trajs.proposed.a.mc, as.ordinal, data=d.t1.fv, exclusion=TRUE, mc.cores=mc.cores)
f.t0.fv = cbind.data.frame(f.t0.fv)
f.t1.fv = cbind.data.frame(f.t1.fv)
colnames(f.t0.fv) = paste('t', 1:length(trajs.proposed.a.mc), sep='')
colnames(f.t1.fv) = paste('t', 1:length(trajs.proposed.a.mc), sep='')
...
errors.proposed.a = .000
errors.proposed.a = c(errors.proposed.a, rep(0, length(items)-length(errors.proposed.a)))
errors.proposed.a = c(1-sum(errors.proposed.a), errors.proposed.a)
...
B = 250
nlls.rank.proposed.a.mc = mclapply(1:B, function(b, trajs, rank, d0.mc, d1.mc, f0.mc, f1.mc, i1.mc, items, combn, errors) {
  cat('.')
  ...
  return( nlls )
}, trajs=trajs.proposed.a.mc, rank=rank.proposed.a.mc, d0.mc=d.t0.mc, d1.mc=d.t1.mc, f0.mc=f.t0.mc, f1.mc=f.t1.mc, i1.mc=i.t1.mc, items=items, combn=combn.vs, errors=errors.proposed.a, mc.cores=mc.cores)

B = 250
nlls.rank.proposed.a.fv = mclapply(1:B, function(b, trajs, rank, d0.mc, d1.mc, f0.mc, f1.mc, f0.fv, i1.fv, items, combn, errors) {
  cat('.')
  ...
  return( nlls )
}, trajs=trajs.proposed.a.mc, rank=rank.proposed.a.mc, d0.mc=d.t0.mc, d1.mc=d.t1.mc, f0.mc=f.t0.mc, f1.mc=f.t1.mc, f0.fv=f.t0.fv, i1.fv=i.t1.fv, items=items, combn=combn.vs, errors=errors.proposed.a, mc.cores=mc.cores)
...
save(nlls.rank.proposed.a.mc, nlls.rank.proposed.a.fv, file='./data/likelihood.rank.proposed.a.mc.rdata')
