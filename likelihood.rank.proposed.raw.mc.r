...
load('./data/rank.proposed.raw.mc.rdata')
rank.proposed.raw.mc = rank.proposed.raw.mc$order[1:20]

trajs.proposed.raw.mc = trajs.proposed.raw.mc[ rank.proposed.raw.mc ]
rank.proposed.raw.mc = 1:20
...
# Convert a data to a set of prefixes.
f.t0.fv = mclapply(trajs.proposed.raw.mc, as.ordinal, data=d.t0.fv, exclusion=TRUE, mc.cores=mc.cores)
f.t1.fv = mclapply(trajs.proposed.raw.mc, as.ordinal, data=d.t1.fv, exclusion=TRUE, mc.cores=mc.cores)
f.t0.fv = cbind.data.frame(f.t0.fv)
f.t1.fv = cbind.data.frame(f.t1.fv)
colnames(f.t0.fv) = paste('t', 1:length(trajs.proposed.raw.mc), sep='')
colnames(f.t1.fv) = paste('t', 1:length(trajs.proposed.raw.mc), sep='')
...
B = 250
nlls.rank.proposed.raw.mc = mclapply(1:B, function(b, trajs, rank, d0.mc, d1.mc, f0.mc, f1.mc, i1.mc, items, combn, errors) {
  cat('.')
  ...
  return( nlls )
}, trajs=trajs.proposed.raw.mc, rank=rank.proposed.raw.mc, d0.mc=d.t0.mc, d1.mc=d.t1.mc, f0.mc=f.t0.mc, f1.mc=f.t1.mc, i1.mc=i.t1.mc, items=items, combn=combn.vs, errors=errors.proposed.raw, mc.cores=mc.cores)

B = 250
nlls.rank.proposed.raw.fv = mclapply(1:B, function(b, trajs, rank, d0.mc, d1.mc, f0.mc, f1.mc, f0.fv, i1.fv, items, combn, errors) {
  cat('.')
  ...
  return( nlls )
}, trajs=trajs.proposed.raw.mc, rank=rank.proposed.raw.mc, d0.mc=d.t0.mc, d1.mc=d.t1.mc, f0.mc=f.t0.mc, f1.mc=f.t1.mc, f0.fv=f.t0.fv, i1.fv=i.t1.fv, items=items, combn=combn.vs, errors=errors.proposed.raw, mc.cores=mc.cores)
...
save(nlls.rank.proposed.raw.mc, nlls.rank.proposed.raw.fv, file='./data/likelihood.rank.proposed.raw.mc.rdata')
