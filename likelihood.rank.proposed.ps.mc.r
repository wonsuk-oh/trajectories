...
load('./data/rank.proposed.ps.mc.rdata')
rank.proposed.ps.mc = rank.proposed.ps.mc$order[1:20]

trajs.proposed.ps.mc = trajs.proposed.ps.mc[ rank.proposed.ps.mc ]
rank.proposed.ps.mc = 1:20
...
B = 250
nlls.rank.proposed.ps.mc = mclapply(1:B, function(b, trajs, rank, d0.mc, d1.mc, f0.mc, f1.mc, i1.mc, items, combn, errors) {
  cat('.')
  ...
  return( nlls )
}, trajs=trajs.proposed.ps.mc, rank=rank.proposed.ps.mc, d0.mc=d.t0.mc, d1.mc=d.t1.mc, f0.mc=f.t0.mc, f1.mc=f.t1.mc, i1.mc=i.t1.mc, items=items, combn=combn.vs, errors=errors.proposed.ps, mc.cores=mc.cores)

B = 250
nlls.rank.proposed.ps.fv = mclapply(1:B, function(b, trajs, rank, d0.mc, d1.mc, f0.mc, f1.mc, f0.fv, i1.fv, items, combn, errors) {
  cat('.')
  ...
  return( nlls )
}, trajs=trajs.proposed.ps.mc, rank=rank.proposed.ps.mc, d0.mc=d.t0.mc, d1.mc=d.t1.mc, f0.mc=f.t0.mc, f1.mc=f.t1.mc, f0.fv=f.t0.fv, i1.fv=i.t1.fv, items=items, combn=combn.vs, errors=errors.proposed.ps, mc.cores=mc.cores)
...
save(nlls.rank.proposed.ps.mc, nlls.rank.proposed.ps.fv, file='./data/likelihood.rank.proposed.ps.mc.rdata')
