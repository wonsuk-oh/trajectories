...
B = 250
nlls.entire.proposed.raw.mc = mclapply(1:B, function(b, trajs, d0.mc, d1.mc, f0.mc, f1.mc, i1.mc, items, combn, errors) {
  cat('.')
  ...
  return( nll )
}, trajs=trajs.proposed.raw.mc, d0.mc=d.t0.mc, d1.mc=d.t1.mc, f0.mc=f.t0.mc, f1.mc=f.t1.mc, i1.mc=i.t1.mc, items=items, combn=combn.vs, errors=errors.proposed.raw, mc.cores=mc.cores)

B = 250
nlls.entire.proposed.raw.fv = mclapply(1:B, function(b, trajs, d0.mc, d1.mc, f0.mc, f1.mc, f0.fv, i1.fv, items, combn, errors) {
  cat('.')
  ...
  return( nll )
}, trajs=trajs.proposed.raw.mc, d0.mc=d.t0.mc, d1.mc=d.t1.mc, f0.mc=f.t0.mc, f1.mc=f.t1.mc, f0.fv=f.t0.fv, i1.fv=i.t1.fv, items=items, combn=combn.vs, errors=errors.proposed.raw, mc.cores=mc.cores)
...
save(nlls.entire.proposed.raw.mc, nlls.entire.proposed.raw.fv, file='./data/likelihood.entire.proposed.raw.mc.rdata')
