...
pool.proposed.a = 1:length(trajs.proposed.a.mc)
...
following.proposed.a.mc = count.following(trajs=trajs.proposed.a.mc, f0=f.t0.mc, f1=f.t1.mc)

fit.itms.proposed.a.mc = mclapply(1:length(trajs.proposed.a.mc), 
  function(k, trajs, items, logits, combn) {
    itm(k=k, trajs, items=items, logits=logits, combn=combn)
}, trajs=trajs.proposed.a.mc, items=items, logits=logits.mc, combn=combn.vs, mc.cores=mc.cores)
...
rank.proposed.a.mc = search.trajectories(
  f0        = f.t0.mc, 
  i1        = i.t1.mc, 
  prefix    = NULL, 
  pool      = pool.proposed.a, 
  fit       = fit.itms.proposed.a.mc, 
  following = following.proposed.a.mc, 
  errors    = errors.proposed.a, 
  mc.cores  = mc.cores
)
rank.proposed.a.mc$order = as.integer(strsplit(x=rank.proposed.a.mc$order[nrow(rank.proposed.a.mc)], split='[.]')[[1]])
...
save(rank.proposed.a.mc, file='./data/rank.proposed.a.mc.rdata')
